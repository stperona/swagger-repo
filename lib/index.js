...
var baseDir = 'spec/';
var mainFile = baseDir + 'swagger.json';
...
exports.swaggerEditorMiddleware = function () {
  ...
  router.get('/backend_swagger.json', function (req, res) {
    ...
    if (_.isEqual(swagger, readJson(mainFile))) {
    ...
    res.end(note + exports.stringify(swagger));
  });
  ...
  router.put('/backend_swagger.json', function (req, res) {
...
exports.swaggerFileMiddleware = function () {
  ...
  router.get('/swagger.json', function (req, res) {
    res.setHeader("Content-Type", "application/json");
    res.end(exports.stringify(exports.bundle()));
  });
...
exports.bundle = function (options) {
  ...
  if (dirExist(definitionsDir)) {
    ...
    swagger.definitions = globJsonObject(definitionsDir, baseName);
  }
...
function globJsonObject(dir, objectPathCb) {
  return _.mapValues(globObject(dir, anyJson, objectPathCb), readJson);
}

function updateGlobObject(dir, object) {
  var knownKeys = globObject(dir, anyJson, baseName);

  _.each(object, function (value, key) {
    var filename = Path.join(dir, key + '.json');
    if (key in knownKeys) {
      filename = knownKeys[key];
      delete knownKeys[key];
    }
    updateJson(filename, value);
  });
